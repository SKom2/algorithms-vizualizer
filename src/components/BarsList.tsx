...
const BarsList = () => {
    ...
    return (
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 list-none grid items-end w-[80%] h-4/5 mx-auto gap-1" style={{gridTemplateColumns: `repeat(${barsLength}, 1fr)`}}>
            {
                bars.map((bar, index) =>
